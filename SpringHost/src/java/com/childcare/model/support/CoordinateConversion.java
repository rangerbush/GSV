...
public class CoordinateConversion
{
  ...
  public UTM latLon2UTM2(double latitude, double longitude)
  {
    LatLon2UTM c = new LatLon2UTM();
    return c.convertLatLonToUTM2(latitude, longitude);
  }
  ...
  {
    public UTM convertLatLonToUTM2(double latitude, double longitude)
    {
      ...
      UTM utm = new UTM();
      utm.east = (int) _easting;
      utm.north = (int) _northing;
      utm.latZone = latZone;
      utm.longZone = longZone;
      return utm;
    }
